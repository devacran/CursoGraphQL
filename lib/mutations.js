...
//estas son las queries de mutcaciones que puedo poner en graphiql
// por ejempo {createCourse}
...
module.exports = {
  //{ input } es lo que le llega como parametro en las consultas
  createCourse: async (root, { input }) => {
    ...
    //Es la info que retorna cuando termina la consulta
    return newCourse;
  },
